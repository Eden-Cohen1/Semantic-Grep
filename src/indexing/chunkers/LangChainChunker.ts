 ...
 * Implements IChunker interface for pluggable chunking strategy
 */
export class LangChainChunker implements IChunker {
  private logger = new Logger("LangChainChunker");
  ...
  constructor() {
    ...
    this.logger.info(
      `LangChainChunker initialized with chunk size: ${this.chunkSize}, overlap: ${this.chunkOverlap}`
    );
  }
  ...
  /**
   * Check if this chunker supports a given language
   * LangChain supports: ts, tsx, js, jsx, py, vue
   */
